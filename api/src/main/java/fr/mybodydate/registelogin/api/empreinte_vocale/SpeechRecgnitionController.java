package fr.mybodydate.registelogin.api.empreinte_vocale;
...
public class SpeechRecgnitionController {
    ...
    @Autowired
    private fr.mybodydate.registelogin.api.services.SpeechRecognitionService speechRecognitionService;
