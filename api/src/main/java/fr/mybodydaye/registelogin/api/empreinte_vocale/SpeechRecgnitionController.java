package fr.mybodydaye.registelogin.api.empreinte_vocale;
...
public class SpeechRecgnitionController {
    ...
    @Autowired
    private fr.mybodydaye.registelogin.api.services.SpeechRecognitionService speechRecognitionService;
